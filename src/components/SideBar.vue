  ...
  <div class="container">
    <el-row class="collapse-row">
      ...
      >
        <el-submenu index="1">
          <template slot="title">
            <i class="icon-item-big el-icon-menu"></i>
            <span>系统管理</span>
          </template>
          <el-submenu index="1-1" v-if="[1].includes(power)">
        ...
        <el-submenu index="2">
          <template slot="title">
            <i class="icon-item-big el-icon-s-marketing"></i>
            <span>绩效考核管理</span>
          </template>
          <el-submenu index="2-1">
            <template slot="title">岗位管理</template>
            <el-menu-item
              index="/s_transfer_apply"
              v-if="[1, 7].includes(power)"
              >调岗申请</el-menu-item
            >
            <el-menu-item index="/p_transfer_apply">调职申请</el-menu-item>
            <el-menu-item
              index="/transfer_manage"
              v-if="[1, 2, 3, 4].includes(power)"
              >职/岗位审核</el-menu-item
            >
          </el-submenu>
          ...
          <el-submenu index="2-3">
            ...
            <el-menu-item
              index="/section_apply"
              v-if="[1, 2, 3, 4, 5, 6].includes(power)"
              >部门申请</el-menu-item
            >
            <el-menu-item
              index="/section_manage"
              v-if="[1, 2, 3].includes(power)"
              >部门审核</el-menu-item
            >
            <el-menu-item
              index="/section_file"
          ...
          <el-submenu index="2-4">
            ...
            <el-menu-item index="/teach_add" v-if="[1, 7].includes(power)"
              >加课报备</el-menu-item
            >
            <el-menu-item index="/teach_minus" v-if="[1, 7].includes(power)"
              >请假报备</el-menu-item
            >
          </el-submenu>
          <el-submenu index="2-5">
            ...
            <el-menu-item
              index="/teach_load"
              v-if="[1, 2, 3, 5].includes(power)"
              >基础教学工作量</el-menu-item
            >
            <el-menu-item index="/scientific_load" v-if="[1, 7].includes(power)"
              >教科研工作量</el-menu-item
            >
            <el-menu-item index="/public_load" v-if="[1, 7].includes(power)"
              >公共工作量</el-menu-item
            >
            <el-menu-item
              index="/load_manage"
              v-if="[1, 2, 3, 6].includes(power)"
              >工作量审核</el-menu-item
            >
          </el-submenu>
          <el-submenu index="2-6">
            <template slot="title">绩效考核管理</template>
            <el-menu-item index="/evaluate" v-if="[1, 2, 3, 4].includes(power)"
              >绩效考核</el-menu-item
            >
            <el-menu-item
              index="/person_evaluation"
              v-if="[1, 7].includes(power)"
              >个人绩效</el-menu-item
            >
          </el-submenu>
